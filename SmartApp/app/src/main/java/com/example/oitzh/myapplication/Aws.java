                        ...
                        try {
                            ...
                            try {
                                ...
                                while (keys.hasNext()) {
                                    ...
                                    if (!((MainActivity)mainActivity).sensorsInfo.containsKey(key)) {
                                        ((MainActivity)mainActivity).sensorsInfo.put(key, new ArrayList<>());
                                    }
                                    if(!((MainActivity)mainActivity).sensorsInfo.get(key).contains(value)) {
                                        ((MainActivity) mainActivity).sensorsInfo.get(key).add(value);
